...
class RecyclerSectionItemDecoration(private val headerOffset: Int, private val sticky: Boolean, @param:NonNull private val sectionCallback: SectionCallback) : ItemDecoration() {
    ...
    private fun inflateHeaderView(parent: RecyclerView): View {
        return LayoutInflater.from(parent.context)
                .inflate(R.layout.header_sms_time_view,
                        parent,
                        false)
    }
